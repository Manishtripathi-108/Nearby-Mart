<div class="relative mt-16 bg-blue-600">
    <svg class="absolute top-0 -mt-5 h-6 w-full text-blue-600 sm:-mt-10 sm:h-16" preserveAspectRatio="none" viewBox="0 0 1440 54">
        ...
        <div class="row-gap-10 mb-8 grid gap-16 lg:grid-cols-6">
            <div class="md:max-w-md lg:col-span-2">
                <a class="inline-flex items-center" href="/" title="Company" aria-label="Go home">
                    <svg class="text-teal-accent-400 w-8" viewBox="0 0 24 24" stroke-linejoin="round" stroke-width="2" stroke-linecap="round" stroke-miterlimit="10" stroke="currentColor" fill="none">
                ...
                <div class="mt-4 lg:max-w-sm">
                    <p class="text-sm text-blue-50">
                        Welcome to Nearby Mart, your one-stop destination for all your shopping needs. Explore a wide range of products at affordable prices.
                    </p>
            ...
            <div class="row-gap-8 grid grid-cols-2 gap-5 md:grid-cols-4 lg:col-span-4">
                <div>
                    ...
                    <ul class="mt-2 space-y-2">
                        <li>
                            <a class="text-deep-purple-50 hover:text-teal-accent-400 transition-colors duration-300" href="/">Electronics</a>
                        </li>
                        <li>
                            <a class="text-deep-purple-50 hover:text-teal-accent-400 transition-colors duration-300" href="/">Clothing</a>
                        </li>
                        <li>
                            <a class="text-deep-purple-50 hover:text-teal-accent-400 transition-colors duration-300" href="/">Home & Kitchen</a>
                        </li>
                        <li>
                            <a class="text-deep-purple-50 hover:text-teal-accent-400 transition-colors duration-300" href="/">Health & Beauty</a>
                        </li>
                    </ul>
                </div>
            </div>
