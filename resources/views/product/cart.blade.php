<x-app-layout>
<div class="flex flex-col max-w-3xl p-6 space-y-4 sm:p-10 dark:bg-gray-50 dark:text-gray-800 justify-center items-center ">
				...
				<div class="flex flex-col justify-between w-full pb-4">
					<div class="flex justify-between w-full pb-2 space-x-2">
						...
						<div class="text-right">
							<p class="text-lg font-semibold">4999.00 Rs</p>
							<p class="text-sm line-through dark:text-gray-400"> </p>
						</div>
					</div>
