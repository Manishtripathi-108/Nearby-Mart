<x-app-layout>
    <div class="flex flex-col justify-around items-center md:flex-row-reverse ">
        ...
        <div class="flex-1 flex-col h-auto w-full ">
            <!--user profile-->
            <div class="flex-1 flex-col h-auto w-full m-10 p-3  space-y-4">
                <div class="flex justify-center items-center">
                    <div class="w-24 h-auto m-2 p-2">
                        <img src="" alt="user" class="h-cover w-full bg-blend-screen">
                    </div>
                </div>
                <div class="flex justify-center items-center">
            ...
            <!--recently viewed poducts-->
            <div class="  flex flex-col h-auto  space-y-4">
                <h2 class="text-2xl font-bold">Recently Viewed</h2>
                <!--product card-slider-->
                <div class="hidden relative flex-col md:flex flex-nowrap space-x-4 items-center justify-evenly ">
                    <!--left slider-button-->
    ...
    <div class="flex-2 flex-col h-auto w-full m-10 p-3 justify-center item-center space-y-4 md:w-1/4">
        ...
        <div
            class="flex justify-center flex-row h-30 w-full  border-2 rounded-lg items-center transition eas-in-out delay-2  hover:border-3 hover:border-blue-400">
            <div class="w-24 h-auto m-2 p-2">
                <img src="{{ asset('images/profile/store.jpeg') }}" alt="user" class="h-cover w-full bg-blend-screen">
            </div>
            <div class="flex-col justify-center items-center">
