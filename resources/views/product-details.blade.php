                ...
                <div class="grid gap-8 md:grid-cols-2">
                    ...
                    <div class="md:py-8">
                        ...
                        <div class="flex gap-2.5">
                            ...
                            <a class="inline-block rounded-lg bg-gray-200 px-8 py-3 text-center text-sm font-semibold text-gray-500 outline-none ring-indigo-300 transition duration-100 hover:bg-gray-300 focus-visible:ring active:text-gray-700 md:text-base" href="#">Buy now</a>
                        </div>
                        <!-- buttons - end -->
                    </div>
                    <!-- content - end -->
