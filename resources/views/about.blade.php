            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                    ...
                    <div class="mt-6 text-gray-500">
                        Nearby Mart is a platform that connects buyers and sellers of goods and services. It is a
                        platform that allows sellers to list their products and services for sale and buyers to search
                        for and purchase products and services. It is a platform that allows sellers to list their
                        products and services for sale and buyers to search for and purchase products and services.
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="mb-16">
        ...
        <dh-component>
            <div class="container flex justify-center mx-auto pt-16">
                <div>
                    <p class="text-gray-500 text-lg text-center font-normal pb-3">Our Team</p>
                    <h1
                    ...
                    <div role="list" aria-label="Behind the scenes People "
                        ...
                        <div role="listitem"
                            ...
                            <div class="rounded overflow-hidden shadow-md bg-white">
                                ...
                                <div class="px-6 mt-16">
                                    <h1 class="font-bold text-3xl text-center mb-1">Manish Kumar</h1>
                                    ...
                                    <div class="w-full flex justify-center pt-5 pb-5">
                                        <a href="https:://www.github.com/ManishKumar76" class="mx-5">
                        ...
                        <div role="listitem"
                            ...
                            <div class="rounded overflow-hidden shadow-md bg-white">
                                ...
                                <div class="px-6 mt-16">
                                    <h1 class="font-bold text-3xl text-center mb-1">Manish Tripathi</h1>
                                    <p class="text-gray-800 text-sm text-center">Full-stack Developer</p>
                                    <p class="text-center text-gray-600 text-base pt-3 font-normal">The CEO's role in
                                        raising a company's corporate IQ is to establish an atmosphere that promotes
                                        knowledge sharing and collaboration.</p>
                                    <div class="w-full flex justify-center pt-5 pb-5">
                                        <a href="https:://www.github.com/Manish-108" class="mx-5">
                                            <div aria-label="Github" role="img">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="#718096" stroke-width="1.5"
                                                    stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div class="rounded overflow-hidden shadow-md bg-white">
                                ...
                                <div class="px-6 mt-16">
                                    ...
                                    <p class="text-center text-gray-600 text-base pt-3 font-normal">Our services
                                        encompass the assessment and repair of property damage caused by water, fire,
                                        smoke, or mold. We can also be a part of the restoration.</p>
                                    <div class="w-full flex justify-center pt-5 pb-5">
                                        <a href="javascript:void(0)" class="mx-5">
                                            <div aria-label="Github" role="img">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
