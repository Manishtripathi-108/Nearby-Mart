<x-app-layout>
    <div class="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow-lg">
        ...
        <form action="{{ route('addresses.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                <label for="address_line_one" class="block text-gray-700">Flat, House no., Building, Company,
                    Apartment</label>
            ...
            <div class="flex justify-end mt-6">
                <button type="submit" class="bg-green-500 text-white px-4 py-2 rounded shadow">
                    Save Address
                </button>
            </div>
        </form>
